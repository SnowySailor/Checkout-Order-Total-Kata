...
def MakeCalculateBestSavingsTests(baseurl):
    class CalculateBestSavingsTests(unittest.TestCase):
        ...
        def test_calculate_best_savings_for_BuyAgetBforCoff_for_item_with_1_amount_returns_0(self):
            ...
            savings = item.special.calculate_best_savings({'identifier': 'test', 'quantity': 1}, dict(), datastore)
        ...
        def test_calculate_best_savings_for_BuyAgetBforCoff_for_item_with_5_amount_returns_correct_savings(self):
            ...
            savings = item.special.calculate_best_savings({'identifier': 'test', 'quantity': 5}, dict(), datastore)
            self.assertEqual(savings, (5.0, [{'identifier': 'test', 'quantity': 3}]))
        ...
        def test_calculate_best_savings_for_BuyAgetBforCoff_for_item_with_buy_1_get_2_50_off(self):
            ...
            savings = item.special.calculate_best_savings({'identifier': 'test', 'quantity': 6}, dict(), datastore)
            self.assertEqual(savings, (10.0, [{'identifier': 'test', 'quantity': 6}]))
        ...
        def test_calculate_best_savings_for_BuyAgetBforCoff_for_item_with_buy_2_get_1_free(self):
            ...
            savings = item.special.calculate_best_savings({'identifier': 'test', 'quantity': 2}, dict(), datastore)
            self.assertEqual(savings, (0, []))
        ...
        def test_calculate_best_savings_for_BuyAgetBforCoff_for_item_with_buy_2_get_1_free_1_occurrence(self):
            ...
            savings = item.special.calculate_best_savings({'identifier': 'test', 'quantity': 3}, dict(), datastore)
            self.assertEqual(savings, (6.0, [{'identifier': 'test', 'quantity': 3}]))
        ...
        def test_calculate_best_savings_for_BuyAgetBforCoff_for_item_with_buy_2_get_1_free_2_occurrences(self):
            ...
            savings = item.special.calculate_best_savings({'identifier': 'test', 'quantity': 7}, dict(), datastore)
            self.assertEqual(savings, (12.0, [{'identifier': 'test', 'quantity': 6}]))
        ...
        def test_calculate_best_savings_for_BuyAgetBforCoff_for_buy_1_get_1_free_limit_2_with_10_items(self):
            ...
            savings = item.special.calculate_best_savings({'identifier': 'test', 'quantity': 10}, dict(), datastore)
            self.assertEqual(savings, (5.0, [{'identifier': 'test', 'quantity': 2}]))
        ...
        def test_calculate_best_savings_for_GetEOLforAoff_with_10_dollar_meat_and_9_dollar_other_item(self):
            ...
            savings = item.special.calculate_best_savings({'identifier': 'meat', 'quantity': 2}, {'soup': 2}, datastore)
            self.assertEqual(savings, (2.25, [{'identifier': 'soup', 'quantity': 1}, {'identifier': 'meat', 'quantity': 2}]))
        ...
        def test_calculate_best_savings_for_GetEOLforAoff_with_10_dollar_meat_and_15_dollar_other_items(self):
            ...
            savings = item.special.calculate_best_savings({'identifier': 'meat', 'quantity': 2}, {'soup': 3}, datastore)
            self.assertEqual(savings, (2.50, [{'identifier': 'soup', 'quantity': 1}, {'identifier': 'meat', 'quantity': 2}]))
        ...
        def test_calculate_best_savings_for_GetEOLforAoff_with_10_dollar_meat_and_15_dollar_other_single_item(self):
            ...
            savings = item.special.calculate_best_savings({'identifier': 'meat', 'quantity': 2}, {'soup': 1}, datastore)
        ...
        def test_calculate_best_savings_for_GetEOLforAoff_with_10_dollar_meat_and_15_dollar_two_other_items(self):
            ...
            savings = item.special.calculate_best_savings({'identifier': 'meat', 'quantity': 2}, {'soup': 1, 'pasta': 15}, datastore)
            self.assertEqual(savings, (5.00, [{'identifier': 'soup', 'quantity': 1}, {'identifier': 'meat', 'quantity': 2}]))
        ...
        def test_calculate_best_savings_for_AforB_with_2_for_5_with_2_items(self):
            ...
            savings = item.special.calculate_best_savings({'identifier': 'soup', 'quantity': 2}, dict(), datastore)
            self.assertEqual(savings, (1.00, [{'identifier': 'soup', 'quantity': 2}]))
        ...
        def test_calculate_best_savings_for_AforB_with_5_for_5_with_10_items(self):
            ...
            savings = item.special.calculate_best_savings({'identifier': 'soup', 'quantity': 10}, dict(), datastore)
            self.assertEqual(savings, (10.00, [{'identifier': 'soup', 'quantity': 10}]))
        ...
        def test_calculate_best_savings_for_AforB_with_5_for_5_with_8_items_and_limit_10(self):
            ...
            savings = item.special.calculate_best_savings({'identifier': 'soup', 'quantity': 8}, dict(), datastore)
            self.assertEqual(savings, (5.00, [{'identifier': 'soup', 'quantity': 5}]))
        ...
        def test_calculate_best_savings_for_AforB_with_10_for_5_with_9_items_returns_0(self):
            ...
            savings = item.special.calculate_best_savings({'identifier': 'soup', 'quantity': 9}, dict(), datastore)
            self.assertEqual(savings, (0.00, []))
        ...
        def test_calculate_best_savings_for_markdown_with_50_off_with_2_items(self):
            ...
            savings = item.special.calculate_best_savings({'identifier': 'soup', 'quantity': 2}, dict(), datastore)
            self.assertEqual(savings, (2.00, [{'identifier': 'soup', 'quantity': 2}]))
        ...
        def test_calculate_best_savings_for_markdown_with_50_off_with_4_items_with_limit_2(self):
            ...
            savings = item.special.calculate_best_savings({'identifier': 'soup', 'quantity': 4}, dict(), datastore)
            self.assertEqual(savings, (2.00, [{'identifier': 'soup', 'quantity': 2}]))
        ...
        def test_calculate_best_savings_for_markdown_with_100_off_with_5_items_with_limit_5(self):
            ...
            savings = item.special.calculate_best_savings({'identifier': 'soup', 'quantity': 5}, dict(), datastore)
            self.assertEqual(savings, (10.00, [{'identifier': 'soup', 'quantity': 5}]))
        ...
        def test_calculate_best_savings_for_markdown_with_0_off_with_5_items_with_limit_5(self):
            ...
            savings = item.special.calculate_best_savings({'identifier': 'soup', 'quantity': 5}, dict(), datastore)
            self.assertEqual(savings, (0.00, [{'identifier': 'soup', 'quantity': 5}]))
        ...
        def test_calculate_best_savings_for_markdown_with_25_off_with_5_items_with_limit_1(self):
            ...
            savings = item.special.calculate_best_savings({'identifier': 'soup', 'quantity': 5}, dict(), datastore)
            self.assertEqual(savings, (0.50, [{'identifier': 'soup', 'quantity': 1}]))
        ...
        def test_calculate_best_savings_for_markdown_with_25_off_with_5_items_with_limit_6(self):
            ...
            savings = item.special.calculate_best_savings({'identifier': 'soup', 'quantity': 5}, dict(), datastore)
            self.assertEqual(savings, (2.50, [{'identifier': 'soup', 'quantity': 5}]))
